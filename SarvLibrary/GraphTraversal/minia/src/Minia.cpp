...
Minia::Minia () : Tool ("minia")
{
    ...
    GraphUnitigsTemplate<64> dummyGraph = GraphUnitigsTemplate<64>::create (new BankStrings ("AGGCGCC",(char*)0),  "-kmer-size 5  -minimizer-size 4 -abundance-min 1  -verbose 0");
    Simplifications<GraphUnitigsTemplate<64>,NodeGU,EdgeGU> graphSimplifications(dummyGraph, 1, false); // get a graph simplifications object just to get default parameters
