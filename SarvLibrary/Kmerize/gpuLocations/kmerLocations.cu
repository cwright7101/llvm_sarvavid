...
void H_GPUKmerizeLocations(const std::string inFilename, const int kmerLen, std::unordered_map<uint64_t, std::vector<int> >& kmerMap) {
...
int main(int argc, char* argv[]){
    ...
    std::unordered_map<uint64_t, std::vector<int> > kmerMap;
