# Install script for directory: /home/chris/Dropbox/chris/PurdueSchool/llvm_sarvavid/SarvLibrary/ErrorCorrection/bloocoo/thirdparty/gatb-core/gatb-core/thirdparty/hdf5/tools/h5dump
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xtoolsapplicationsx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/chris/Dropbox/chris/PurdueSchool/llvm_sarvavid/SarvLibrary/ErrorCorrection/bloocoo/build/ext/gatb-core/bin/gatb-h5dump")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/gatb-h5dump" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/gatb-h5dump")
