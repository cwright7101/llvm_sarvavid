...
public:
    ...
    int AlignRead(const Sequence &seq, std::deque<HashAlignerRecord> &records, int min_match, int max_records = (1 << 30));
    int AlignReadLocal(const Sequence &seq, std::deque<HashAlignerRecord> &records, int min_match, int max_mismatch, int max_records = (1 << 30));
    int AlignSequence(const Sequence &seq, std::deque<HashAlignerRecord> &records, int min_match, double similar, int max_records = (1 << 30));
